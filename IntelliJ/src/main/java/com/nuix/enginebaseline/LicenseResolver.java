 ...
 *         <li>{@link LicenseResolver#fromServer(String, int)}</li>
 *         <li>{@link LicenseResolver#fromCloud()}</li>
 *         <li>{@link LicenseResolver#fromDongle()}</li>
 *         <li>{@link LicenseResolver#fromAnySource()}</li>
 *     </ul></li>
...
public class LicenseResolver {
    private static final Logger log = LogManager.getLogger(LicenseResolver.class);
     ...
     */
    public static LicenseResolver fromDongle() {
        LicenseResolver result = new LicenseResolver();
     ...
     */
    public static LicenseResolver fromCloud() {
        LicenseResolver result = new LicenseResolver();
     ...
     */
    public static LicenseResolver fromAnySource() {
        LicenseResolver result = new LicenseResolver();
     ...
     */
    public LicenseResolver withRequiredFeatures(String... features) {
        if (features == null) {
            return this;
        }
     ...
     * @return This license resolver for chained method calls.
     */
    public LicenseResolver withMinWorkerCount(int minWorkerCount) {
     ...
     * @return This license resolver for chained method calls.
     */
    public LicenseResolver withMaxWorkerCount(int maxWorkerCount) {
     ...
     * @return This license resolver for chained method calls.
     */
    public LicenseResolver withLicenseCredentialsProvider(CredentialsCallback credentialsCallback) {
     ...
     * @return This license resolver for chained method calls.
     */
    public LicenseResolver withLicenseCredentials(String userName, String password) {
     ...
     * @return This license resolver for chained method calls.
     */
    public LicenseResolver withLicenseCredentialsResolvedFromENV(String usernameEnvVar, String passwordEnvVar) {
        this.credentialsCallback = credentialsCallbackInfo -> {
     ...
     * @return This license resolver for chained method calls.
     */
    public LicenseResolver withLicenseCredentialsResolvedFromENV() {
     ...
     * @return This license resolver for chained method calls.
     */
    public LicenseResolver withCertificateTrustCallback(CertificateTrustCallback certificateTrustCallback) {
     ...
     * @return This license resolver for chained method calls.
     */
    public LicenseResolver withTrustAllCertificates() {
    ...
    public boolean obtainLicense(@NonNull Engine engine) throws Exception {
        ...
        Stream<AvailableLicence> filteredLicensesStream = availableLicensesStream.filter((availableLicense -> {
            ...
            if (availableLicense.canChooseWorkers() && maxWorkerCount > 0 && availableWorkerCount > maxWorkerCount) {
